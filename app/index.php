...
$server_map = json_decode(file_get_contents('json/heartlessgaming-servermap.json'));
$server_ip = $server_map->gameServerIp;
/*1
...
<body>
	...
	<?php foreach ($server_map as $gamename => $gameservers_info) : ?>
